...
<span class="token comment">// 移除所有偶数</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6),l=[i];function p(o,c){return s(),a("div",null,l)}const d=n(t,[["render",p],["__file","a_simple_map.html.vue"]]),m=JSON.parse(`{"path":"/zh/posts/ti/a_simple_map.html","title":"A Simple Map","lang":"zh-CN","frontmatter":{"icon":"pen-to-square","date":"2024-04-06T00:00:00.000Z","category":["题"],"comment":true,"description":"A Simple Map 实现了基本的增删改查 lambda表达式","head":[["meta",{"property":"og:url","content":"https://mister-hope.github.io/zh/posts/ti/a_simple_map.html"}],["meta",{"property":"og:site_name","content":"ECROF"}],["meta",{"property":"og:title","content":"A Simple Map"}],["meta",{"property":"og:description","content":"A Simple Map 实现了基本的增删改查 lambda表达式"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-05-02T07:17:53.000Z"}],["meta",{"property":"article:author","content":"ECROF"}],["meta",{"property":"article:published_time","content":"2024-04-06T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-05-02T07:17:53.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"A Simple Map\\",\\"image\\":[\\"\\"],\\"datePublished\\":\\"2024-04-06T00:00:00.000Z\\",\\"dateModified\\":\\"2024-05-02T07:17:53.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"ECROF\\",\\"url\\":\\"https://ecrof88.github.io/\\"}]}"]]},"headers":[{"level":3,"title":"lambda表达式","slug":"lambda表达式","link":"#lambda表达式","children":[]}],"git":{"createdTime":1714634023000,"updatedTime":1714634273000,"contributors":[{"name":"ECROF88","email":"maomao8672@outlook.com","commits":2}]},"readingTime":{"minutes":2.34,"words":702},"filePathRelative":"zh/posts/ti/a_simple_map.md","localizedDate":"2024年4月6日","excerpt":"\\n<h4>实现了基本的增删改查</h4>\\n<div class=\\"language-c++\\" data-ext=\\"c++\\" data-title=\\"c++\\"><pre class=\\"language-c++\\"><code>template &lt;typename KeyType, typename ValueType&gt;\\nclass Map\\n{\\nprivate:\\n    vector&lt;pair&lt;KeyType, ValueType&gt;&gt; pairs;\\npublic:\\n    void insert(KeyType key, ValueType value)\\n    {   \\n        // cout&lt;&lt;key&lt;&lt;\\" \\"&lt;&lt;value&lt;&lt;endl;\\n        for(auto i:pairs)\\n        {\\n            if(i.first==key)\\n            {\\n                cout&lt;&lt;\\"Key already exists\\"&lt;&lt;endl;\\n                return;\\n            }\\n        }\\n        pair&lt;KeyType,ValueType&gt; p(key,value);\\n        pairs.push_back(p);\\n    }\\n    void output()\\n    {\\n        for(auto i:pairs)\\n        {   \\n            cout&lt;&lt;i.first&lt;&lt;\\" \\"&lt;&lt;i.second&lt;&lt;endl;\\n        }\\n    }\\n    void remove(KeyType key)\\n    {\\n        // for(auto i=pairs.begin();i!=pairs.end();i++)\\n        // {\\n        //     if(i-&gt;first==key)\\n        //     {\\n        //         pairs.erase(i);\\n        //     }\\n        // }\\n        //std::remove_if函数并不直接删除元素，而是将不满足条件的元素移到容器的末尾，\\n        // 并返回一个迭代器，指向第一个不满足条件的元素。\\n        // 然后你可以使用容器的erase方法来删除这些元素。\\n        pairs.erase(std::remove_if(pairs.begin(), pairs.end(), [&amp;](const auto&amp; pair) {\\n            return pair.first == key;\\n        }), pairs.end());\\n    }\\n    ValueType get(KeyType key)\\n    {   \\n        if(pairs.size()==0)\\n        {\\n            cout&lt;&lt;\\"Map is empty\\"&lt;&lt;endl;\\n            return -1;\\n        }\\n        for(auto i:pairs)\\n        {\\n            if(i.first==key)\\n            {\\n                return i.second;\\n            }\\n        }\\n        cout&lt;&lt;\\"Key not found\\"&lt;&lt;endl;\\n        return pairs.end()-&gt;second;\\n    }\\n    int size()\\n    {\\n        return pairs.size();\\n    }\\n};\\nint main()\\n{\\n    Map&lt;string,int&gt; mymap;\\n    for(auto i = 'a';i&lt;'f';i++)\\n    {   \\n        mymap.insert(string(1,i),i);\\n    }\\n    string s=string(1,'b');\\n    mymap.output();//a 97 b 98 c 99 d 100 e 101\\n    cout&lt;&lt;\\"map_size:\\"&lt;&lt;mymap.size()&lt;&lt;endl;//5\\n    cout&lt;&lt;\\"find key 'b':\\"&lt;&lt;mymap.get(\\"b\\")&lt;&lt;endl;//98\\n    mymap.remove(\\"b\\");\\n    mymap.output();//a 97 c 99 d 100 e 101\\n    cout&lt;&lt;\\"map_size:\\"&lt;&lt;mymap.size()&lt;&lt;endl;//4\\n}\\n</code></pre></div>","autoDesc":true}`);export{d as comp,m as data};
